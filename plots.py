...
def plot_line():
    ...
    model1 = np.array([7.1, 7.2, 7.3, 7.4, 7.5])
    Ours = np.array([15, 15.3, 15.5, 15.7, 15.9])
    ...
    plt.plot(x, model1, marker='s', markersize=markersize, color="blue", label="OpenGauss-DiskANN", linewidth=linewidth)
    ...
    plt.ylabel(f"Delete throughout", fontsize=15)
...
if __name__ == '__main__':
    # plot_bar() # 单个柱状图
    # plot_line() #折线图
    plot_multi_bar() # 多个柱状图
    # plot_multi_bar_cut() # 多个柱状图,切片
    # plot_bar_and_line() # 柱状图和折线图
    # plot_scatters() # 散点图
    # plot_hetmap() # 热力图
    # plot_ablation_bar_in_one() # 消融实验柱状图
    # plot_two_bar_in_one()
